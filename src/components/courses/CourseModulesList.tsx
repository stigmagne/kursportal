        ...
        <div className="space-y-6">
            ...
            {modules
                ...
                .map((module, moduleIndex) => (
                    <div
                        key={module.id}
                        className="border-2 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-xl overflow-hidden transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                    >
                        <div className="px-6 py-4 border-b-2 border-black bg-gray-50/50">
                        ...
                        <ul className="divide-y-2 divide-gray-100">
                            {module.lessons
                                ...
                                .map((lesson, lessonIndex) => (
                                    <li key={lesson.id} className="px-6 py-4 flex items-center justify-between hover:bg-yellow-50/50 transition-colors group">
                                        <span className="flex items-center gap-4">
                                            ...
                                            <span className="font-bold text-gray-800 group-hover:text-black">{lesson.title}</span>
                                        </span>
